...
<div class="z-5 relative w-60 h-48 rounded-xl border-2 p-4 m-2 grow sm:grow-0 border-slate-400 dark:border-slate-600 bg-slate-200 dark:bg-slate-700 hover:drop-shadow-md dark:hover:drop-shadow-none dark:hover:shadow-slate-400 hover:cursor-pointer transition-all " >
